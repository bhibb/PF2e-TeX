...
\begin{multicols}{2}
  ...
  \begin{pf-titlebox}{GM Background Notes}
    \textcolor{title1}{Some basic info to get the story started.}
  \end{pf-titlebox}
  ...
  \begin{creaturebox}[title=Corrupted Giant Rat (Monster Core pg. 288 1.1)]
    \basics[
      Perception=+2,
      str=+3,
      dex=+2,
