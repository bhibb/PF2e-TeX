...
\begin{multicols}{2}
  ...
  \begin{creaturebox}[title=Corrupted Swarm Voice (NPC Core pg. 210)]
    \basics[
      Perception=+2,
  ...
  \begin{creaturebox}[title=Tunnel Viper (NPC Core pg. 210)]
    \basics[
      Perception=+2,
      skills=+1,
      str=+3,
  ...
  \begin{pf-parchment}[\textcolor{title1}{Description}]
    \textcolor{title1}{This is a description of the space. It is very spacious and descriptive. Read this aloud.}
  \end{pf-parchment}
