...
\addSidebar % For some reason this is the only spot this can go without being in the wrong place. It adds space before the Overview, though, which is not ideal. TODO
  ...
  As the party continues down the path toward Daven-Skort, the horses start bucking wildly as the town gate comes into view. The fire in the woods has flushed out a trio of Ankhrav from a hive somewhere in the vicinity, and the three creatures burst out of the fire and attack the party.

  \begin{creaturebox}{Ankhrav (3)}{3}
