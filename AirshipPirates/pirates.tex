...
\addSidebar % For some reason this is the only spot this can go without being in the wrong place. It adds space before the Overview, though, which is not ideal. TODO
  ...
  The PC's were dispatched from Absalom when reports of a dragon attack on the small town of Daven-Skort reached the Pathfinder Society. They have traveled a several day's journey by cart and mule to  
