...
\addSidebar % For some reason this is the only spot this can go without being in the wrong place. It adds space before the Overview, though, which is not ideal. TODO
  ...
  \begin{creaturebox}{Flaming Tree}{3}
    ...
    \textbf{Disable} DC 17 Survival (trained) to put out the fire with water or dirt.\\
    \textbf{AC} 19; \textbf{Fort} +10, \textbf{Ref} +11\\
    \textbf{HP} 26 (BT 13); \textbf{Immunities} critical hits, object immunities, precision damage\\
